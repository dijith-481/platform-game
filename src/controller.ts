...
export class Controller {
  ...
  addEventListeners() {
    ...
    if ("ontouchstart" in window || navigator.maxTouchPoints > 0) {
      if (upButton) {
        upButton.addEventListener("touchstart", () =>
          handleButton.call(this, "w", true),
        );
        upButton.addEventListener("touchend", () =>
          handleButton.call(this, "w", false),
        );
      }
      if (rightButton) {
        rightButton.addEventListener("touchstart", () =>
          handleButton.call(this, "d", true),
        );
        rightButton.addEventListener("touchend", () =>
          handleButton.call(this, "d", false),
        );
      }
      if (leftButton) {
        leftButton.addEventListener("touchstart", () =>
          handleButton.call(this, "a", true),
        );
        leftButton.addEventListener("touchend", () =>
          handleButton.call(this, "a", false),
        );
      }
      if (fullscreenButton) {
    ...
    window.addEventListener("keydown", (e) =>
      handleButton.call(this, e.key, true),
    );
    window.addEventListener("keyup", (e) =>
      handleButton.call(this, e.key, false),
    );
  }
}
